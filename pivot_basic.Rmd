...
acs <- 
  here::here("data/acs/acs_2017_1.rds") %>% 
  read_rds()
...
Let's see an example of a tibble that actually does need `pivot_wider()` to be tidy. `acs` contains data from the 2013-2017 [American Community Survey](https://www.census.gov/programs-surveys/acs), obtained through the [tidycensus](https://walkerke.github.io/tidycensus/) package. 
