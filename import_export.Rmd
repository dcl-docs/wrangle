...
`vroom::vroom()` is so fast because it doesn't actually read in all the data. It reads in a portion of the data, remembers where it stopped, and then reads more in later if needed. This is all done automatically and you shouldn't need to think much about how it works. 
